  ...
  return (
    <section className="panel p-6">
      <div className="mb-6">
        ...
        <h2 className="mt-3 text-2xl font-semibold text-ink dark:text-white">Log income or expenses</h2>
        <p className="mt-2 text-sm leading-7 text-slate-600 dark:text-slate-300">
          Keep each entry short and categorized so the summary cards stay useful.
        </p>
      </div>
