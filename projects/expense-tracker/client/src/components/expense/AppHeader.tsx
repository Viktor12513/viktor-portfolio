      ...
      <div className="container-shell flex flex-col gap-5 py-6 sm:flex-row sm:items-center sm:justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <h1 className="text-2xl font-semibold tracking-tight text-ink dark:text-white">Expense Tracker</h1>
            <p className="mt-1 text-sm text-slate-600 dark:text-slate-300">
              A simple dashboard for tracking money coming in and going out.
            </p>
          </div>
        </div>
