  ...
  return (
    <section className="panel p-6">
      <div className="mb-6">
        ...
        <h3 className="mt-3 text-2xl font-semibold text-ink dark:text-white">
          {editingPost ? 'Update an existing post' : 'Write a blog post'}
        </h3>
        <p className="mt-3 text-sm leading-7 text-slate-600 dark:text-slate-300">
          This demo keeps the workflow simple: title, excerpt, content, category, and publish status.
        </p>
      </div>
