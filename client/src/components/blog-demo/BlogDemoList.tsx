...
export function BlogDemoList({ posts, busyPostId, onEdit, onDelete }: BlogDemoListProps) {
  if (posts.length === 0) {
    return (
      <section className="panel p-8 text-center">
        <h3 className="text-2xl font-semibold text-ink dark:text-white">No posts yet</h3>
